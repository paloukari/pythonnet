...
namespace Python.EmbeddingTest
{
    public class TestRuntime
    {
        ...
        {
            Runtime.Runtime.Interop.Py_Finalize(); // In case another test left it on.
            Assert.AreEqual(0, Runtime.Runtime.Interop.Py_IsInitialized());
            Runtime.Runtime.Interop.Py_Initialize();
            Assert.AreEqual(1, Runtime.Runtime.Interop.Py_IsInitialized());
            Runtime.Runtime.Interop.Py_Finalize();
            Assert.AreEqual(0, Runtime.Runtime.Interop.Py_IsInitialized());
        }
        ...
        public static void RefCountTest()
        {
            ...
            Runtime.Runtime.Interop.Py_IncRef(op);
            Assert.AreEqual(2, Runtime.Runtime.Refcount(op));
            Runtime.Runtime.Interop.Py_DecRef(op);
            Assert.AreEqual(1, Runtime.Runtime.Refcount(op));
        ...
        public static void PyCheck_Iter_PyObject_IsIterable_Test()
        {
            ...
            var pyList = Runtime.Runtime.Interop.PyList_New(0);
            ...
            var pyListIter = Runtime.Runtime.Interop.PyObject_GetIter(pyList);
            ...
            var pyFloat = Runtime.Runtime.Interop.PyFloat_FromDouble(2.73);
        ...
        public static void PyCheck_Iter_PyObject_IsIterable_ThreadingLock_Test()
        {
            ...
            var threading = Runtime.Runtime.Interop.PyImport_ImportModule("threading");
            var threadingDict = Runtime.Runtime.Interop.PyModule_GetDict(threading);
            var lockType = Runtime.Runtime.Interop.PyDict_GetItemString(threadingDict, "Lock");
            var lockInstance = Runtime.Runtime.Interop.PyObject_CallObject(lockType, Runtime.Runtime.Interop.PyTuple_New(0));
