...
namespace Python.Runtime
{
    ...
    public class PySequence : PyObject, IEnumerable
    {
        ...
        {
            return Runtime.Interop.PySequence_Check(value.obj);
        }
        ...
        {
            IntPtr op = Runtime.Interop.PySequence_GetSlice(obj, i1, i2);
            if (op == IntPtr.Zero)
            {
        ...
        {
            int r = Runtime.Interop.PySequence_SetSlice(obj, i1, i2, v.obj);
            if (r < 0)
            {
                throw new PythonException();
            }
        ...
        {
            int r = Runtime.Interop.PySequence_DelSlice(obj, i1, i2);
            if (r < 0)
            {
                throw new PythonException();
            }
        ...
        {
            int r = Runtime.Interop.PySequence_Index(obj, item.obj);
            if (r < 0)
            {
        ...
        {
            int r = Runtime.Interop.PySequence_Contains(obj, item.obj);
            if (r < 0)
            {
                throw new PythonException();
            }
        ...
        {
            IntPtr op = Runtime.Interop.PySequence_Concat(obj, other.obj);
            if (op == IntPtr.Zero)
            {
                throw new PythonException();
            }
        ...
        {
            IntPtr op = Runtime.Interop.PySequence_Repeat(obj, count);
            if (op == IntPtr.Zero)
            {
                throw new PythonException();
            }
